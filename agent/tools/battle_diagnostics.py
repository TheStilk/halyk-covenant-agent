    ...
    *,
    ...
    for sc in scenario_ids:
        ...
        if not by_type.get(kyc_key):
            # No KYC file → related-party detection falls back to
            # keyword heuristics (see metrics.py Holding/Capital fallback),
            # which is a weaker signal. Cells depending on related-party
            # classification for this scenario deserve a second look.
            no_kyc.append(sc)
