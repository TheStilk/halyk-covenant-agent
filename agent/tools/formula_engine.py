...
_MIN_DIR_RE = re.compile(
    ...
    r"кемінде|кем\s+емес|төмендемеу|аздау\s+болмауы|аз\s+болмауы|төмен\s+болмауы",
    re.I,
)
_MAX_DIR_RE = re.compile(
    ...
    r"аспау|аспауы\s+тиіс|аспауға|артық\s+болмауы|артық\s+болмауға|ең\s+к[өо]п|артпауы",
    re.I,
)
