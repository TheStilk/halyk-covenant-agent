...
def _compute_rp_to_revenue(m: ScenarioMetrics, thr: float, direction: str) -> FormulaResult:
    ...
    # Band-rescue fired (see _status_max_ratio): reproduces public GT but is
    # unverified on private thresholds — downgrade below CONFIDENCE_THRESHOLD
    # so it routes through the LLM cross-check / low_confidence diagnostics
